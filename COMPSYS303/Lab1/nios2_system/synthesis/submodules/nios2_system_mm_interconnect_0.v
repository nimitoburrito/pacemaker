...
module nios2_system_mm_interconnect_0 (
	...
	wire   [12:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> lcd_control_slave_agent:cp_channel
	...
	wire  [102:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> switches_s1_agent:cp_data
	...
	wire   [12:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> leds_red_s1_agent:cp_channel
	...
	wire          cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> leds_green_s1_agent:cp_valid
	wire  [102:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> leds_green_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                     // leds_green_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> leds_green_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> leds_green_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> leds_green_s1_agent:cp_endofpacket
	...
	wire  [102:0] switches_s1_agent_rp_data;                                                 // switches_s1_agent:rp_data -> router_012:sink_data
	...
	wire          leds_green_s1_agent_rp_valid;                                              // leds_green_s1_agent:rp_valid -> router_014:sink_valid
	wire  [102:0] leds_green_s1_agent_rp_data;                                               // leds_green_s1_agent:rp_data -> router_014:sink_data
	wire          leds_green_s1_agent_rp_ready;                                              // router_014:sink_ready -> leds_green_s1_agent:rp_ready
	wire          leds_green_s1_agent_rp_startofpacket;                                      // leds_green_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          leds_green_s1_agent_rp_endofpacket;                                        // leds_green_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire   [12:0] router_006_src_channel;                                                    // router_006:src_channel -> onchip_mem_s1_rsp_width_adapter:in_channel
	...
	wire   [12:0] onchip_mem_s1_rsp_width_adapter_src_channel;                               // onchip_mem_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire   [12:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> onchip_mem_s1_cmd_width_adapter:in_channel
	...
	wire   [12:0] rsp_demux_002_src0_channel;                                                // rsp_demux_002:src0_channel -> crosser_001:in_channel
	...
	wire   [12:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> rsp_mux:sink2_channel
	...
	wire          leds_green_s1_agent_rdata_fifo_src_valid;                                  // leds_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] leds_green_s1_agent_rdata_fifo_src_data;                                   // leds_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          leds_green_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_012:in_0_ready -> leds_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> leds_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> leds_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                         // leds_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> leds_green_s1_agent:rdata_fifo_sink_error
	...
	nios2_system_mm_interconnect_0_router_006 router_007 (
	...
	nios2_system_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (sdram_pll_sys_clk_clk),                 //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (sdram_pll_sys_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
